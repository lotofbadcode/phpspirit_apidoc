...
<body class="fixed-left">
    ...
    <div class="wrapper-page">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3">
                    ...
                    <form class="form-horizontal m-t-30" action="<?php echo url('login/register')?>">
                        ...
                        <div class="form-group row m-t-20">
                            <div class="col-12 text-right">
                                <button jump='{"type":1,"url":"<?php echo url('project.index/index')?>","message":"注册成功"}' class="btn btn-primary w-md waves-effect waves-light spirit_submit" data-loading-text="Loading..." type="button">注册</button>
                            </div>
                        </div>
        ...
        <div class="m-t-40 text-center">
            <p class="text-white">已经有一个账户 ? <a href="<?php echo url('login/login'); ?>" class="font-500 font-14 text-white font-secondary"> 登录 </a> </p>
