                ...
                <div class="p-3">
                    ...
                    <form class="form-horizontal m-t-30" action="index.html">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" data-parsley-required-message="用户名必填" required class="form-control" id="username" placeholder="输入用户名">
                        </div>

                        <div class="form-group">
                            <label for="username">姓名</label>
                            <input type="text" data-parsley-required-message="姓名必填" required class="form-control" id="truename" placeholder="输入姓名">
                        </div>

                        <div class="form-group">
                            <label for="password">密码</label>
                            <input type="password" data-parsley-required-message="密码必填" required class="form-control" id="password" placeholder="输入密码">
                        </div>

                        <div class="form-group">
                            <label for="userpassword">确认密码</label>
                            <input type="password" data-parsley-equalto="#password" data-parsley-equalto-message="两次密码输入不一致" data-parsley-required-message="确认密码必填" required class="form-control" id="repassword" placeholder="确认密码">
                        </div>
